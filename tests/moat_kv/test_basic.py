...
# (b) we can use trio.
@pytest.mark.trio
async def test_00_trio_clock(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
...
@pytest.mark.trio
async def test_00_runner(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
...
@pytest.mark.trio
async def test_01_basic(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
...
@pytest.mark.trio
async def test_02_cmd(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
    async with stdtest(args={"init": 123}, tocks=50) as st:
        assert st is not None
        async with st.client() as c:
            assert (await c.get(P(":"))).value == 123
...
@pytest.mark.trio
async def test_03_three(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
...
@pytest.mark.trio
async def test_03_lots(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
