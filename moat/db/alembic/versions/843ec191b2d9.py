...
def upgrade() -> None:
    ...
    op.alter_column(
        "labeltyp", "sheettyp_id", existing_type=mysql.INTEGER(display_width=11), nullable=False,
    )
...
def downgrade() -> None:
    ...
    op.alter_column(
        "labeltyp", "sheettyp_id", existing_type=mysql.INTEGER(display_width=11), nullable=True,
    )
    # ### end Alembic commands ###
