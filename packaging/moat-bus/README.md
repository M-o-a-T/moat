...
(differential transmission, frequency modulation) is not suitable.

The protocol is designed to be implemented in software. It achieves
...
The MoatBus C code runs on top of the [RIOT] embedded operating system
