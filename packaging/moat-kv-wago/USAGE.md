...
by default. All attributes are also looked up in the higher nodes, so
you can set per-type or per-server defaults easily.
...
The controller to connect to. Do not run this more than once for any
given server.
