...
@pytest.mark.trio
async def test_basic(autojump_clock):  # pylint: disable=unused-argument  # noqa: D103
...
@pytest.mark.trio
@pytest.mark.xfail
async def test_split(autojump_clock):  # pylint: disable=unused-argument  # noqa: D103
