...
Basically, a MoaT "app" is any code that hooks into a device's command
dispatcher.
...
The watchdog is responsible for rebooting the system if/when the
hardware gets wedged, or a fault causes the MoaT task to exit.
