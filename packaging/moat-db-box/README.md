...
of books. Some boxes can be nested, with locations. Some boxes can be moved
(e.g. a bookcase or a drawer), some can't (the compartments within a drawer)
...
box number, and one with a text that describes the content – or at least
