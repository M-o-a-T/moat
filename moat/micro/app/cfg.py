...
class Cmd(BaseCmd):
    ...
    async def stream_r(self, msg):
        ...
        Args:
            p: path. An empty path is the root.
    ...
    async def cmd_w(self, p, d=NotGiven):
        ...
        Args:
            p: data path. It cannot be empty. Destinations are
               autogenerated. A path element of `None`, if last, appends
               to a list.

            d: data replacing the destination. `NotGiven` (or omitting the
               parameter) deletes.
