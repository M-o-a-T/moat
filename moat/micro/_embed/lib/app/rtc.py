...
class Cmd(BaseCmd):
    ...
    async def cmd_w(self, p=(), d=_NotGiven):
        ...
        Args:
            p: the path. It cannot be empty. Destination dicts are autogenerated.
            d: the data replacing the destination.
               `NotGiven` deletes the setting. Not passing ``d`` in deletes the modifier.
        """
        if not p:
