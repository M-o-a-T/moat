...
<!-- Synopsis: start -->
CFFI-based Python wrappers for Bosch Sensortec sensor chips.
<!-- Synopsis: end -->

<!-- Main: start -->
## BMV080 Particulate Matter Sensor

The `moat.api.bosch.bmv080` module provides a Python interface to the BMV080
particulate matter sensor via CFFI.

### Features

- PM1, PM2.5, and PM10 mass and number concentration measurements
