...
A port always has a name. It may have a description, address, VLAN, and
MAC.
...
It may have an associated VLAN, a DHCP range, a domain template for
DHCP, and a master network.
