...
@pytest.mark.trio
async def test_22_auth_basic(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
...
@pytest.mark.trio
async def test_23_auth_test(autojump_clock):  # pylint: disable=unused-argument  # noqa: ARG001, D103
