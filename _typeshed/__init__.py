...
from dataclasses import Field as Field  # noqa:TC003
from enum import StrEnum as StrEnum
from os import PathLike
from types import FrameType, TracebackType
from types import NoneType as NoneType

from collections.abc import Awaitable, Buffer, Callable, Iterable, Sequence, Sized
...
class SliceableBuffer(Buffer, Protocol):
    def __getitem__(self, slice: slice, /) -> Sequence[int]: ...  # noqa:A002
